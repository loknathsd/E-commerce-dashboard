...
const Register = () => {
    ...
    return (
        <div className='bg-gray-100 w-full lg:h-[100vh] flex justify-center'>
            <div className=' lg:w-[50%] md:w-[60%] shadow-lg  h-5/6 bg-white mt-10 rounded-lg text-center md:p-8 max-sm:p-8'>
                <div className='font-serif' >
                    ...
                    <div className='lg:flex md:flex justify-center gap-3 mt-10 mb-8'>
                        <button className='border-2 border-gray-30 w-72 md:w-52  rounded-md py-2 flex justify-center items-center align-middle '>
                            <FcGoogle className='mr-3 text-2xl' /> SignUp with Google
                        </button>
                        <button className=' max-sm:mt-5 border-2 border-gray-30 w-72 md:w-52  rounded-md py-2 flex justify-center items-center align-middle '>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} >
                        ...
                        <div className='lg:flex md:flex justify-center gap-3 text-left mt-4 mb-6 font-serif'>
                            <div>
                                ...
                                <input className=' mt-2 border-2 border-gray-30 w-72 md:w-52 py-2 rounded-md px-3' {...register("email")} required />
                            </div>
                            <div>
                                <label htmlFor="">Password</label><br />
                                <input className='mt-2 border-2 border-gray-30 w-72 md:w-52 py-2 rounded-md px-3' {...register("password")} required />
                            </div>
                        </div>
